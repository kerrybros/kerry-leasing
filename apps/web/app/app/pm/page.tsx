...
const mockPmData: PmRow[] = [
  { unitNumber: '101', vin: '1FVACWDT5DHBP0001', lastLofDate: 'Jan 15, 2026', lastLofMileage: 142000, currentMileage: 153800, nextDueDate: 'Apr 15, 2026', nextDueMileage: 157000, status: 'Due Soon' },
  { unitNumber: '102', vin: '1FVACWDT5DHBP0002', lastLofDate: 'Feb 2, 2026',  lastLofMileage: 98500,  currentMileage: 105200, nextDueDate: 'May 2, 2026',  nextDueMileage: 113500, status: 'OK' },
  { unitNumber: '103', vin: '3AKJHHDR7MSMS0003', lastLofDate: 'Dec 10, 2025', lastLofMileage: 210000, currentMileage: 228400, nextDueDate: 'Mar 10, 2026', nextDueMileage: 225000, status: 'Overdue' },
  { unitNumber: '104', vin: '3AKJHHDR7MSMS0004', lastLofDate: 'Mar 1, 2026',  lastLofMileage: 177000, currentMileage: 180100, nextDueDate: 'Jun 1, 2026',  nextDueMileage: 192000, status: 'OK' },
  { unitNumber: '105', vin: '1XPBD49X4JD0005',  lastLofDate: 'Feb 20, 2026', lastLofMileage: 85000,  currentMileage: 89600,  nextDueDate: 'Apr 12, 2026', nextDueMileage: 90000,  status: 'Due Soon' },
  { unitNumber: '107', vin: '1XPBD49X4JD0007',  lastLofDate: 'Jan 5, 2026',  lastLofMileage: 133000, currentMileage: 148700, nextDueDate: 'Apr 5, 2026',  nextDueMileage: 148000, status: 'Overdue' },
  { unitNumber: '110', vin: '1FVACWDT5DHBP0010', lastLofDate: 'Mar 18, 2026', lastLofMileage: 62000,  currentMileage: 64200,  nextDueDate: 'Jun 18, 2026', nextDueMileage: 77000,  status: 'OK' },
  { unitNumber: '112', vin: '1FVACWDT5DHBP0012', lastLofDate: 'Mar 5, 2026',  lastLofMileage: 195000, currentMileage: 197800, nextDueDate: 'Jun 5, 2026',  nextDueMileage: 210000, status: 'OK' },
  { unitNumber: '115', vin: '3AKJHHDR7MSMS0015', lastLofDate: 'Nov 20, 2025', lastLofMileage: 240000, currentMileage: 260300, nextDueDate: 'Feb 20, 2026', nextDueMileage: 255000, status: 'Overdue' },
];
...
export default function PmPage() {
  ...
  const overdue = mockPmData.filter((r) => r.status === 'Overdue').length;
  const dueSoon = mockPmData.filter((r) => r.status === 'Due Soon').length;
  const ok = mockPmData.filter((r) => r.status === 'OK').length;
  ...
  return (
    <div className="mx-auto px-4 py-8 max-w-6xl flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <KpiCard label="Total Units" value={mockPmData.length} />
